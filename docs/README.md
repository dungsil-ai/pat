...
**주요 개선 사항 (지난 7일):**
- **아키텍처 문서 보완**: `close-translation-issues` 액션의 이슈 자동 종료 흐름을 `architecture.md`에 추가
...
### 최신 업데이트
- **2026-07-13**: 주간 문서 현행화 (아키텍처 문서에 번역 거부 이슈 자동 종료 흐름 보완)
...
**최종 업데이트:** 2026-07-13 | **문서 버전:** 1.4.6
