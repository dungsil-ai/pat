...
**주요 개선 사항 (지난 7일):**
- **번역 거부 이슈 자동 종료**: 다음 번역 실행에서 더 이상 미번역 항목이 남지 않은 모드의 `translation-refused` 이슈를 해결 코멘트와 함께 자동으로 닫음
- **Vitest 4.1.0 반영**: 테스트 러너가 `vitest` 4.1.0으로 갱신되어 최신 테스트 환경을 사용
...
### 최신 업데이트
- **2026-07-06**: 주간 문서 현행화 (번역 거부 이슈 자동 종료, Vitest 4.1.0 반영)
...
**최종 업데이트:** 2026-07-06 | **문서 버전:** 1.4.5
